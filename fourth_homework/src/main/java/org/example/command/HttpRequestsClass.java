...
public class HttpRequestsClass {
    UserDTO getLoggedInUser(String email, String password) {
        ...
        try {
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/login");
    ...
    List<UserDTO> getAllUsers() {
        ...
        try {
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/user");
    ...
    MonthlyBudgetDTO getBudget() {
        ...
        try {
            ...
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/budget?date="+date+"&user="+CurrentUser.currentUser.getId());
    ...
    boolean deleteAccount(int id) {
        ...
        try {
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/user/"+id);
    ...
    List<TransactionDTO> filterTransactions(Date date, int categoryId, String type, int userId) {
        ...
        try {
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/transaction?date="+date+"&category="+categoryId+"&type="+type+"&user="+userId);
    ...
    boolean editTransaction(int id, BigDecimal sum, int categoryId, Date date, String description) {
        ...
        try {
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/transaction/"+id);
    ...
    TransactionCategoryDTO getCategoryOrGoalWithId(int id) {
        ...
        try {
            URL url = new URL("http://localhost:8080/fourth_homework-1.0-SNAPSHOT/category/"+id);
